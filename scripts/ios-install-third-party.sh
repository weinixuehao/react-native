...
fetch_and_unpack glog-0.3.4.tar.gz https://github.com/weinixuehao/glog/archive/v0.3.4.tar.gz c14fffec477d7afca557fe87c1ec4adc357ef0ba "\"$SCRIPTDIR/ios-configure-glog.sh\""
